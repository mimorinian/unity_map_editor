...
class LayaPBRSpecularGUI : ShaderGUI
{
    ...
    public void FindProperties(MaterialProperty[] props)
    {
        ...
        renderQueue = FindProperty("_RenderQueue", props);
    }
    ...
    public void ShaderPropertiesGUI(Material material)
    {
        ...
        EditorGUI.BeginChangeCheck();
        {
            ...
            //Diffuse
            m_MaterialEditor.TexturePropertySingleLine(Styles.albedoText, diffuseTexture, diffuseColor);
            
            //specular
            bool hasSpecularMap = false;
            hasSpecularMap = specularTexture.textureValue != null;
            m_MaterialEditor.TexturePropertySingleLine(Styles.specularText, specularTexture, hasSpecularMap ? null : specularColor);

            //smoothness
            //m_MaterialEditor.ShaderProperty(smoothness, Styles.smoothnessText, MaterialEditor.kMiniTextureFieldLabelIndentLevel);
            bool showSmoothnessScale = hasSpecularMap;
            ...
            //renderQueue
            GUILayout.BeginHorizontal();
            GUILayout.Label(Styles.renderQueueText, GUILayout.Width(120));
            var renderQ = (RenderQueue)renderQueue.floatValue;
            renderQ = (RenderQueue)EditorGUILayout.Popup((int)renderQ, Styles.renderQueueNames);
            GUILayout.EndHorizontal();
            ...
            if (EditorGUI.EndChangeCheck())
            {
                ...
                if ((RenderMode)material.GetFloat("_Mode") == RenderMode.Custom)
                {
                    ...
                    //renderQueue
                    renderQueue.floatValue = (float)renderQ;
                    material.SetInt("_RenderQueue", (int)renderQ);
                    switch ((int)renderQ)
                    {
                        case 0:
    ...
    public static class Styles
    {
        ...
        public static GUIContent renderQueueText = new GUIContent("RenderQueue", "RenderQueue");
        ...
        public static readonly string[] renderQueueNames = Enum.GetNames(typeof(RenderQueue));
